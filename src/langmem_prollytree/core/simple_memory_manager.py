...
class SimpleMemoryManager:
    ...
    def __init__(self,
        ...
        self.search_engine = HierarchicalSearchEngine(
            store=self,  # Pass self as store interface
        ...
        for result in results:
            memory = Memory(
                ...
                metadata={
                    ...
                    "timestamp": result.created_at.timestamp() if result.created_at else time.time(),
    ...
    async def asearch(self, namespace: str, prefix: str) -> List[Tuple[str, Any]]:
        ...
        return [(result.key, result.value.get('content', result.value)) for result in results]
