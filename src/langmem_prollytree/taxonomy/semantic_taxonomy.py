        ...
        return {
            "profile": {
                "personal": {
                    "identity": {
                        ...
                        "personality": ["traits", "mbti", "enneagram", "strengths", "weaknesses"]
                    },
                    "location": {
                        "current": ["country", "state", "city", "neighborhood", "address"],
                    ...
                    "family": {
                        ...
                        "extended": ["grandparents", "aunts_uncles", "cousins", "in_laws"]
                    },
                    "health": {
                        "physical": ["conditions", "allergies", "medications", "fitness"],
                    ...
                    "appearance": {
                        "physical": ["height", "build", "hair", "eyes", "distinguishing"],
                ...
                "professional": {
                    "current": {
                        ...
                        "responsibilities": ["primary", "secondary", "projects", "kpis"],
                        "compensation": ["salary", "equity", "benefits", "perks"]
                    },
                    "history": {
                        "companies": ["names", "positions", "durations", "reasons_left"],
                        "industries": ["types", "experience", "expertise", "preferences"],
                        "achievements": ["awards", "recognition", "milestones", "impact"],
                        "failures": ["lessons", "mistakes", "learnings", "improvements"]
                    },
                    "skills": {
                        "technical": {
                            "programming": ["languages", "frameworks", "tools", "years"],
                            "data": ["databases", "analytics", "ml", "visualization"],
                            "infrastructure": ["cloud", "devops", "networking", "security"],
                            "domain": ["industry", "business", "regulatory", "specialized"]
                        },
                        "soft": {
                            "leadership": ["style", "experience", "strengths", "development"],
                            "communication": ["written", "verbal", "presentation", "languages"],
                            "collaboration": ["teamwork", "conflict", "mentoring", "networking"],
                            "thinking": ["analytical", "creative", "strategic", "critical"]
                        },
                        "certifications": ["active", "expired", "pursuing", "planned"]
                    },
                    "education": {
                        "formal": ["degrees", "institutions", "majors", "years"],
                        "continuing": ["courses", "workshops", "conferences", "self_study"],
            ...
            "preferences": {
                "technology": {
                    ...
                    "ui": {
                        ...
                        "accessibility": ["font_size", "contrast", "motion", "screen_reader"],
                        "customization": ["shortcuts", "aliases", "macros", "plugins"]
                    },
                    "platforms": {
                        "operating_systems": ["primary", "secondary", "mobile", "preferences"],
                        "cloud": ["providers", "services", "regions", "preferences"],
                        "databases": ["relational", "nosql", "graph", "time_series"],
                        "architecture": ["monolith", "microservices", "serverless", "edge"]
                    },
                    "ai": {
                ...
                "personal": {
                    ...
                    "social": {
                        "interactions": ["introverted", "extroverted", "ambivert", "preferences"],
                        "relationships": ["quality", "quantity", "maintenance", "boundaries"],
                        "activities": ["group", "individual", "virtual", "in_person"],
                        "communication": ["style", "frequency", "medium", "topics"]
                    },
                    "values": {
                        "core": ["family", "career", "health", "spirituality", "community"],
                        "ethics": ["principles", "causes", "activism", "donations"],
                        "politics": ["leaning", "issues", "engagement", "preferences"],
                        "environment": ["sustainability", "consumption", "lifestyle", "advocacy"]
                    },
                    "finance": {
                        "management": ["budgeting", "saving", "investing", "tracking"],
                        "goals": ["short_term", "long_term", "retirement", "legacy"],
                        "risk": ["tolerance", "insurance", "emergency", "diversification"],
                        "spending": ["priorities", "habits", "splurges", "restrictions"]
                    }
                }
            },
            "experience": {
                "projects": {
                    ...
                    "types": {
                        "personal": ["side_projects", "hobbies", "learning", "creative"],
                        "professional": ["work", "freelance", "consulting", "products"],
                        "open_source": ["contributions", "maintenance", "creation", "collaboration"],
                        "academic": ["research", "papers", "thesis", "coursework"]
                    }
                },
                "achievements": {
                    "professional": ["promotions", "awards", "recognition", "milestones"],
            ...
            "context": {
                "current": {
                    ...
                    "environment": {
                        ...
                        "devices": ["primary", "secondary", "capabilities", "limitations"],
                        "distractions": ["notifications", "interruptions", "noise", "multitasking"],
                ...
                "history": {
                    "conversations": {
                        ...
                        "important": ["decisions", "insights", "breakthroughs", "agreements"]
                    },
                    "interactions": {
                        "patterns": ["frequency", "duration", "depth", "satisfaction"],
                        "preferences": ["style", "pace", "detail", "format"],
                        "feedback": ["positive", "negative", "suggestions", "adjustments"]
                    }
                }
            },
            "knowledge": {
                "domains": {
                    ...
                    "technical": {
                        "computer_science": ["algorithms", "data_structures", "theory", "systems"],
                    ...
                    "business": {
                        ...
                        "skills": ["analysis", "presentation", "negotiation", "leadership"]
                    },
                    "creative": {
            ...
            "relationships": {
                "people": {
                    ...
                    "community": {
                        "neighbors": ["immediate", "building", "neighborhood", "community"],
            ...
            "goals": {
                ...
                "progress": {
                    ...
                    "obstacles": ["blockers", "challenges", "dependencies", "resources"],
            ...
            "behavior": {
                ...
                "adaptation": {
                    ...
                    "learning": ["from_mistakes", "from_success", "from_others", "continuous"],
    ...
    def get_related_paths(self, path: str, max_distance: int = 2) -> List[str]:
        ...
        if max_distance > 0:
            ...
            for desc in descendants:
                if self.get_path_depth(desc) - self.get_path_depth(path) <= max_distance:
                    related.add(desc)
