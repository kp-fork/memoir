...
import pytest
from langmem_prollytree.taxonomy import (
    SemanticTaxonomy,
    get_taxonomy,
    TaxonomyCategory
)
...
class TestSemanticTaxonomy:
    ...
    def test_get_category(self):
        ...
        assert taxonomy.get_category("profile.personal.identity") == TaxonomyCategory.PROFILE
        assert taxonomy.get_category("preferences.technology") == TaxonomyCategory.PREFERENCES
        assert taxonomy.get_category("goals.timeframes.short_term") == TaxonomyCategory.GOALS
    ...
    def test_related_paths(self):
        ...
        related = taxonomy.get_related_paths("profile.personal.identity.name", max_distance=2)
...
class TestTaxonomyCategories:
    ...
    def test_all_categories_present(self):
        ...
        expected = [
            "PROFILE", "PREFERENCES", "EXPERIENCE", "CONTEXT",
            "KNOWLEDGE", "RELATIONSHIPS", "GOALS", "BEHAVIOR"
        ]
